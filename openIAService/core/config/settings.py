...
class Settings(BaseSettings):
    ...
    gemini_model: Optional[str] = Field(env="GEMINI_MODEL")
    gemini_embedding_model: Optional[str] = Field(env="GEMINI_EMBEDDING_MODEL")
    ...
    ollama_url: Optional[str] = Field(env="OLLAMA_URL")
    ollama_model: Optional[str] = Field(env="OLLAMA_MODEL")
    ollama_embedding_model: Optional[str] = Field(env="OLLAMA_EMBEDDING_MODEL")
